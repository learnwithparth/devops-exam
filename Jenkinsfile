pipeline {
    agent any
    environment{
        IMAGE_NAME= 'pm310/spring_exam-app:${IMAGE}'
    }
            ...
            steps {
                script {
                    ...
                    sshagent(['ec2-ubuntu-key']) {
                        sh "scp server-cmds.sh ec2-user@54.95.222.132:/home/ec2-user "
                        sh "ssh -o StrictHostKeyChecking=no ec2-user@54.95.222.132 ${shellCmd}"
